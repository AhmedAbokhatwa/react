...
def get_context(context):
    ...
    context.update(
        {
            ...
            "layout_direction": "rtl" if is_rtl_custom() else "ltr",
    ...
    print("hellopqqqqqqqqqqqqqqqqqqqqqqqqqqqq", is_rtl_custom())
    return context


def is_rtl_custom(rtl=None):
    from frappe import local

    if rtl is None:
        return local.lang in ["ar", "he", "fa", "ps", "ckb"]
    return rtl
